...
def parse_args(args=None):
    ...
    parser.add_argument(
        "-m", "--module", help="Name of module to add",
    )
...
def update_modules_json(module_name, modules_json='modules.json'):
    ...
    # add module to json
    modules['repos']['https://github.com/nf-core/modules.git']['modules']['nf-core'][module_name] = modules['repos']['https://github.com/nf-core/modules.git']['modules']['nf-core']['coverm/contig']
    # sort json dict
    sorted_modules = modules.copy()
    sorted_modules['repos']['https://github.com/nf-core/modules.git']['modules']['nf-core'] = dict(sorted(modules['repos']['https://github.com/nf-core/modules.git']['modules']['nf-core'].items()))
    # write json file
...
def main(args=None):
    ...
    add_module_to_nfcore_yml(
        args.module,
        args.directory + '/.nf-core.yml'
    )
